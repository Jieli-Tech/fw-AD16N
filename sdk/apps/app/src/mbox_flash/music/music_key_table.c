...
#pragma bss_seg(".music_key_table.data.bss")
#pragma data_seg(".music_key_table.data")
#pragma const_seg(".music_key_table.text.const")
#pragma code_seg(".music_key_table.text")
#pragma str_literal_override(".music_key_table.text.const")
...
#define IRFF00_MUSIC_TRIPLE_KICK	\
                                /*00*/    NO_MSG,\
                                /*01*/    NO_MSG,\
								/*02*/    NO_MSG,\
								/*03*/    NO_MSG,\
...
const u16 irff00_msg_mbox_music_table[][IR_KEY_MAX_NUM] = {			//Music模式下的遥控转换表
...
#define IOKEY_MUSIC_TRIPLE_KICK \
							/*00*/		NO_MSG,\
							/*01*/		NO_MSG,\
							/*02*/		NO_MSG,\
							/*03*/		NO_MSG,\
...
#define ADKEY_MUSIC_TRIPLE_KICK \
							/*00*/		NO_MSG,\
							/*01*/		NO_MSG,\
							/*02*/		NO_MSG,\
							/*03*/		NO_MSG,\
...
#if KEY_IR_EN
    case KEY_TYPE_IR:
        msg = irff00_msg_mbox_music_table[key_status][key_num];
        break;
#endif
    default:
        break;
