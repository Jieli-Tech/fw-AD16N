...
const u16 matkey_msg_rtc_table[][MATRIX_KEY_MAX_NUM] = {
    /*短按*/		{MATKEY_RTC_SHORT},
    /*短按抬起*/	{MATKEY_RTC_SHORT_UP},
    /*长按*/		{MATKEY_RTC_LONG},
    /*连按*/		{MATKEY_RTC_HOLD},
    /*长按抬起*/	{MATKEY_RTC_LONG_UP},
#if (KEY_DOUBLE_CLICK_EN)
    /*双击*/		{MATKEY_RTC_DOUBLE_KICK},
    /*双击*/		{MATKEY_RTC_TRIPLE_KICK},
#endif
};
#endif
...
u16 rtc_key_msg_filter(u8 key_status, u8 key_num, u8 key_type)
{
    ...
    case KEY_TYPE_MATRIX:
        msg = matkey_msg_rtc_table[key_status][key_num];
        break;
#endif
    default:
        break;
