#pragma bss_seg(".linein_mode_key.data.bss")
#pragma data_seg(".linein_mode_key.data")
#pragma const_seg(".linein_mode_key.text.const")
#pragma code_seg(".linein_mode_key.text")
#pragma str_literal_override(".linein_mode_key.text.const")
